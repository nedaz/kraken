...
class AlignmentBlock 
{
  public:
    ...
    bool merge(const AlignmentBlock& toMerge); 
  ...
  private:
    ...
    bool isWithinBound(int num1, int num2);
    ...
    int mergeBoundary;   /// Boundary to allow around the merge point of two alignment blocks
};
